      ...
      <Link href={`/app/forms/${form.id}/builder`} style={{ textDecoration: "none" }}>
        ...
        >
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
            ...
            <span style={{ fontSize: "11px", color: "var(--text-faint)", fontFamily: "var(--font-body)", fontWeight: 300 }}>
          ...
          {/* Footer */}
          <div style={{ fontSize: "11px", color: "var(--text-faint)", fontFamily: "var(--font-body)", fontWeight: 300 }}>
            Edited {timeAgo}
          </div>
          ...
          <button
            ...
            style={{
              ...
              color: "var(--text-dim)", fontFamily: "var(--font-body)", cursor: "pointer",
              opacity: 0,
            ...
            onMouseLeave={(e) => { e.currentTarget.style.color = "var(--text-dim)"; e.currentTarget.style.borderColor = "var(--text-faint)"; }}
          >
            Delete
          </button>
